...
async function fetchPosts() {
  ...
  console.log(data.data[2].attributes.inventors.data);
  return data.data[2].attributes.inventors.data;
}
  ...
  return (
    ...
    >
      ...
      {isLoading ? (
        ...
        >
          <h1 className={styles.titlePage}>Himpunan Mahasiswa Jurusan</h1>
          <Swiper
            navigation={true}
